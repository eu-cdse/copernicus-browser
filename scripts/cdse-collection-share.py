...
CCM_VHR_IMAGE_2024 = "b016cf66-b68e-472d-8421-1fe9d384762f"

with open("./scripts/cdse-users.txt") as file:
    users = [line.rstrip() for line in file]

    collections = [CCM_VHR_IMAGE_2018, CCM_VHR_IMAGE_2021, CCM_VHR_IMAGE_2024]
    ...
    for i, user in enumerate(users):
        ...
        print(
            f"{len(collections)} collections shared with {user}, {i + 1}/{len(users)}"
        )
