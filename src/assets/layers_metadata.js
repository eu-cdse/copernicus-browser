...
export const PREDEFINED_LAYERS_METADATA = [
  ...
  },
  {
    ...
    description: () =>
      t`# Color Visualization\n\n\n\nThis script returns a color visualization of the digital elevation model, using a colorBlend function, assigning continuous natural terrain colors to the elevation borders.\n\n\n\nMore info [here.](https://custom-scripts.sentinel-hub.com/dem/dem-color/)`,
  },
  {
    match: [
  ...
  },
  {
    ...
    description: () =>
      t`# Grayscale Visualization\n\n\n\nThis script returns a grayscale visualization of the digital elevation model, using a colorBlend function, assigning continuous colors to the elevation borders.\n\n\n\nMore info [here.](https://custom-scripts.sentinel-hub.com/dem/dem-grayscale/)`,
  },
  {
    match: [
  ...
  },
  {
    ...
    description: () =>
      t`# Sepia Visualization\n\n\n\nThis script returns a sepia visualization of the digital elevation model, using a colorBlend function, assigning continuous colors to the elevation borders.\n\n\n\nMore info [here.](https://custom-scripts.sentinel-hub.com/dem/dem-sepia/)`,
  },
  {
    match: [
