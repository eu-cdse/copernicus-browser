  ...
  },
  {
    ...
    pins: [
      ...
      // },
      {
        ...
        themeId: 'MONITORING',
        description:
          'The severe ecological crisis caused by the European spruce bark beetle (Ips typographus) in the Frankenwald forest (Upper Franconia, Bavaria). This mass outbreak, significantly exacerbated by severe heat and drought years spanning roughly 2018 through 2023, led to devastating, large-scale spruce tree mortality. The continuous favorable breeding conditions caused the beetle population to explode, overwhelming the weakened spruce monocultures. Visible from orbit, the damage appears as dramatic, expanding scars: patches of dying, reddish-brown spruce crowns (the initial stage of infestation) and subsequently massive, exposed areas resulting from sanitary clear-cutting operations. These stark, contrasting areas against the healthy green surrounding forest dramatically illustrate the scale of the dieback, turning the former spruce stands into a prominent signature of climate-change-fueled forest decline across Central Europe.  \nMore information is available [here](https://www.waldwissen.net/en/forestry/forest-protection/detecting-bark-beetle-damage-with-aerial-images#:~:text=The%20highest%20densities%20of%20the,clear%20areas%20%28Figure%201%29)!',
      },
      {
