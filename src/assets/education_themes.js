...
export const EDUCATION_THEMES = [
  {
    ...
    content: [
      {
        name: 'EOB3 Monitoring Earth (S2L2A) API',
        service: 'WMS',
    ...
    pins: [
      ...
      },
      {
        ...
        evalscripturl: '',
        visualizationUrl: 'https://services.sentinel-hub.com/ogc/wms/fa0736-YOUR-INSTANCEID-HERE',
        dataFusion: [],
        description:
    ...
    pins: [
      {
        ...
        themeId: 'WILDFIRES',
        description:
          'The 2019-2020 [Australian bushfire season](https://www.esa.int/ESA_Multimedia/Images/2019/11/Bushfires_rage_in_Australia) has destroyed 46 million hectares of land, including buildings. Nearly [3 billion animals died](https://www.bbc.com/news/world-australia-53549936) or were displaced. Wildfires occur in Australia every summer (the peak is usually in February), but a severe drought in 2020 made it the hottest and driest year on record with high temperatures and windy conditions. Learn more [here](https://www.directrelief.org/2020/06/six-months-after-australias-wildfires-recovery-continues/). Air pollution is one of the factors that can be monitored to assess the severity of wildfires by Copernicus [Sentinel-5P](https://custom-scripts.sentinel-hub.com/custom-scripts/sentinel/sentinel-5p/). Check out the concentration of nitrogen dioxide (NO2) [here](https://sentinelshare.page.link/NQUD).\n\n**Timelapse**: View [here](https://sentinelshare.page.link/vT3o) in EO Browser.',
      },
      {
