...
// Copy of https://gitlab.com/IvanSanchez/Leaflet.GridLayer.GoogleMutant with changes made to the attribution logo placement
...
L.GridLayer.GoogleMutant = L.GridLayer.extend({
  ...
  _setupAttribution: function (ev) {
    ...
    this._logoContainer.className = 'google-logo';
    this._map._controlContainer.appendChild(this._logoContainer);
  },
