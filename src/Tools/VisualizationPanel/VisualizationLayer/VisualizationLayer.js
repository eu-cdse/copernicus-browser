...
class VisualizationLayer extends Component {
  state = { detailsOpen: false, actionsOpen: false };
  ...
  render() {
    ...
    const { actionsOpen, detailsOpen } = this.state;
    ...
    return (
      ...
      >
        ...
        />
        <ActionBar className="layer-actions" actionsOpen={actionsOpen && isActive} actions={layerActions} />
        <LayerDetails
          viz={viz}
          legend={legend}
