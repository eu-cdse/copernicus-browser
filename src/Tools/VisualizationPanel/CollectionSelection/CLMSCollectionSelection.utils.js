    ...
    options: [
          ...
          },
          {
            ...
            options: [
              ...
              },
              {
                ...
                id: COPERNICUS_CLMS_FAPAR_1KM_DAILY,
                consolidationPeriods: [
                  {
                    label: 'None',
                    id: COPERNICUS_CLMS_FAPAR_1KM_DAILY,
                  ...
                  {
                    label: AttributeConsolidationPeriodValues.RT0.label,
                    id: COPERNICUS_CLMS_FAPAR_1KM_DAILY_RT0,
                  },
                  {
                    label: AttributeConsolidationPeriodValues.RT1.label,
                    id: COPERNICUS_CLMS_FAPAR_1KM_DAILY_RT1,
                  },
                  {
                    label: AttributeConsolidationPeriodValues.RT2.label,
                    id: COPERNICUS_CLMS_FAPAR_1KM_DAILY_RT2,
                  },
                  {
                    label: AttributeConsolidationPeriodValues.RT6.label,
                    id: COPERNICUS_CLMS_FAPAR_1KM_DAILY_RT6,
                  },
                ],
              },
              {
          ...
          },
          {
            ...
            options: [
              ...
              },
              {
                ...
                id: COPERNICUS_CLMS_DMP_1KM_DAILY,
                consolidationPeriods: [
                  {
                    label: 'None',
                    id: COPERNICUS_CLMS_DMP_1KM_DAILY,
                  ...
                  {
                    label: AttributeConsolidationPeriodValues.RT0.label,
                    id: COPERNICUS_CLMS_DMP_1KM_DAILY_RT0,
                  },
                  {
                    label: AttributeConsolidationPeriodValues.RT1.label,
                    id: COPERNICUS_CLMS_DMP_1KM_DAILY_RT1,
                  },
                  {
                    label: AttributeConsolidationPeriodValues.RT2.label,
                    id: COPERNICUS_CLMS_DMP_1KM_DAILY_RT2,
                  },
                  {
                    label: AttributeConsolidationPeriodValues.RT6.label,
                    id: COPERNICUS_CLMS_DMP_1KM_DAILY_RT6,
                  },
                ],
              },
              {
      ...
      },
      {
        ...
        options: [
          ...
          //     { label: 'lie_baltic_250m_daily', id: 'lie_baltic_250m_daily' },
          //     { label: 'lie_northernhemisphere_500m_daily', id: 'lie_northernhemisphere_500m_daily' },
          //   ],
          // },
          // {
