...
export default class AirbusFePleiadesNeoDataSourceHandler extends AbstractRRDDataSourceHandler {
  datasource = DATASOURCES.RRD_AIRBUS_FE_PLEIADAS_NEO;

  KNOWN_COLLECTIONS = Object.values(
    ROLLING_ARCHIVE_CONSTELLATIONS_PRODUCT_TYPES_MAP[RRD_CONSTELLATIONS.AIRBUS_FE_PLEIADAS_NEO],
  );

  searchGroupLabel = 'Pléiades Neo';
}
