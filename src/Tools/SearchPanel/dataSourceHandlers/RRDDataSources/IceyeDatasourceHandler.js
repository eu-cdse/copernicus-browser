...
export default class IceyeDatasourceHandler extends AbstractRRDDataSourceHandler {
  datasource = DATASOURCES.RRD_ICEYE;

  KNOWN_COLLECTIONS = Object.values(
    ROLLING_ARCHIVE_CONSTELLATIONS_PRODUCT_TYPES_MAP[RRD_CONSTELLATIONS.ICEYE],
  );

  searchGroupLabel = 'ICEYE';
}
