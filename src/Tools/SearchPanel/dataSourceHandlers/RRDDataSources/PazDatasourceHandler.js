...
export default class PazDatasourceHandler extends AbstractRRDDataSourceHandler {
  datasource = DATASOURCES.RRD_PAZ;

  KNOWN_COLLECTIONS = Object.values(ROLLING_ARCHIVE_CONSTELLATIONS_PRODUCT_TYPES_MAP[RRD_CONSTELLATIONS.PAZ]);

  searchGroupLabel = 'PAZ';
}
