...
export default class SkySatDataSourceHandler extends AbstractRRDDataSourceHandler {
  datasource = DATASOURCES.RRD_SKYSAT;

  KNOWN_COLLECTIONS = Object.values(
    ROLLING_ARCHIVE_CONSTELLATIONS_PRODUCT_TYPES_MAP[RRD_CONSTELLATIONS.SKYSAT],
  );

  searchGroupLabel = 'SkySat';
}
