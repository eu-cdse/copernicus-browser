...
import { getWorldCoverAnnualCloudlessMosaic } from './DatasourceRenderingComponents/dataSourceTooltips/MosaicsTooltip';
import { COPERNICUS_WORLDCOVER_ANNUAL_CLOUDLESS_MOSAIC } from './dataSourceConstants';
...
export default class MosaicDataSourceHandler extends DataSourceHandler {
  ...
  getDescriptionForDataset = (datasetId) => getWorldCoverAnnualCloudlessMosaic();
