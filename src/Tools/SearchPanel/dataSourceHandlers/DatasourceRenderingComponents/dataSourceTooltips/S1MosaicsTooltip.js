...
import { S1_MONTHLY_MOSAIC_DH, S1_MONTHLY_MOSAIC_IW } from '../../dataSourceConstants';

const getSentinel1DHMosaic = () => {
  const { displayRange } = MOSAIC_AVAILABILITY[S1_MONTHLY_MOSAIC_DH];
  return t`
...
const getSentinel1IWMosaic = () => {
  const { displayRange } = MOSAIC_AVAILABILITY[S1_MONTHLY_MOSAIC_IW];
  return t`
