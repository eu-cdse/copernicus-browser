...
import {
  ...
  COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS,
  COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_ID_BY_LAYER_ID,
  COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_BANDS_BY_LAYER_ID,
  COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_IDS,
  COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_ID_BY_LAYER_ID,
  COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_BANDS_BY_LAYER_ID,
...
export default class CLMSDataSourceHandler extends AbstractBYOCDataSourceHandler {
  ...
  /**
   * Overrides the base willHandle to deduplicate allLayers by (collectionId, layerId).
   *
   * This is an edge case specific to CPMCE and CPMCH (and similar future collections): they
   * split data across per-year collections that each reference the same shared confidence-layer
   * collection in KNOWN_COLLECTIONS. Without deduplication, the confidence-layer entries would
   * be pushed to allLayers once per year dataset. The URL and dataset registration are gated on
   * the same newLayers check, which is safe because each collection is served from exactly one
   * URL (tied to its configurationId), so a fully-seen dataset can never arrive on a new URL.
   */
  willHandle(service, url, name, layers, _preselected) {
    let handlesAny = false;
    const seenKeys = new Set(this.allLayers.map((l) => `${l.collectionId}:${l.layerId}`));

    for (const datasetId of Object.keys(this.KNOWN_COLLECTIONS)) {
      const newLayers = layers.filter((l) => {
        if (!this.KNOWN_COLLECTIONS[datasetId].includes(l.collectionId)) {
          return false;
        }
        const key = `${l.collectionId}:${l.layerId}`;
        if (seenKeys.has(key)) {
          return false;
        }
        seenKeys.add(key);
  ...
  leafletZoomConfig = {
    ...
    [COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1_COLLECTION_IDS.CPBSA]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_CPBSA_10M_YEARLY_V1_COLLECTION_IDS.CPBSACL]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1_COLLECTION_IDS.CPFLD]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_CPFLD_10M_YEARLY_V1_COLLECTION_IDS.CPFLDCL]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1_COLLECTION_IDS.CPBSB]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_CPBSB_10M_YEARLY_V1_COLLECTION_IDS.CPBSBCL]: { min: 7, max: 25 },
    ...
    [COPERNICUS_CLMS_VLCC_FOREST_ADDITIONAL_SUPPORT_LAYER_EUROPE_10M_3YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_VLCC_FOREST_ADDITIONAL_SUPPORT_LAYER_EUROPE_10M_3YEARLY_V1_COLLECTION_ID]: {
      min: 7,
      max: 25,
    },
    [COPERNICUS_CLMS_VLCC_SECONDARY_CROP_DURATION_EUROPE_10M_YEARLY_V1]: { min: 7, max: 25 },
    ...
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2017_EUROPE_10M_YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2018_EUROPE_10M_YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2019_EUROPE_10M_YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2020_EUROPE_10M_YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2021_EUROPE_10M_YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2022_EUROPE_10M_YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2023_EUROPE_10M_YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2017_EUROPE_10M_YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2018_EUROPE_10M_YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2019_EUROPE_10M_YEARLY_V1]: { min: 7, max: 25 },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2020_EUROPE_10M_YEARLY_V1]: { min: 7, max: 25 },
  ...
  KNOWN_COLLECTIONS = {
    ...
    [COPERNICUS_CLMS_VLCC_PLOUGHING_INDICATOR_EUROPE_10M_YEARLY_V1]: ['c9750aed-88a5-4a0d-907a-1cc406052886'],
    [COPERNICUS_CLMS_VLCC_FOREST_TYPE_EUROPE_10M_3YEARLY_V1]: [
      COPERNICUS_CLMS_VLCC_FOREST_TYPE_EUROPE_10M_3YEARLY_V1_COLLECTION_ID,
    ],
    [COPERNICUS_CLMS_VLCC_TREE_COVER_DENSITY_EUROPE_10M_YEARLY_V1]: [
    ...
    [COPERNICUS_CLMS_VLCC_HERBACEOUS_COVER_EUROPE_10M_YEARLY_V1]: ['e2d6c154-b874-454e-9bb1-43d04b45a92d'],
    [COPERNICUS_CLMS_VLCC_CROPPING_SEASONS_EUROPE_10M_YEARLY_V1]: ['93db885a-db11-4a7d-b035-bd6020a4447d'],
    [COPERNICUS_CLMS_LST_GLOBAL_3KM_HOURLY_V3]: ['12225aec-26dd-4e2c-bbfd-994c253c1ba8'],
    [COPERNICUS_CLMS_CPSCE_10M_YEARLY_V1]: ['86a3ea15-e4b0-4aed-874e-492f0934e800'],
    [COPERNICUS_CLMS_VLCC_FOREST_ADDITIONAL_SUPPORT_LAYER_EUROPE_10M_3YEARLY_V1]: [
      COPERNICUS_CLMS_VLCC_FOREST_ADDITIONAL_SUPPORT_LAYER_EUROPE_10M_3YEARLY_V1_COLLECTION_ID,
    ],
    [COPERNICUS_CLMS_VLCC_SECONDARY_CROP_DURATION_EUROPE_10M_YEARLY_V1]: [
    ...
    [COPERNICUS_CLMS_VLCC_FOREST_TYPE_EUROPE_100M_3YEARLY_V1]: ['d267ca76-6afb-4992-99d6-67c67df4820c'],
    [COPERNICUS_CLMS_VLCC_GRASSLAND_EUROPE_100M_YEARLY_V1]: ['f99fe8ab-0c49-4c68-acd2-1687b0e04816'],
    [COPERNICUS_CLMS_VLCC_TREE_COVER_DENSITY_EUROPE_100M_YEARLY_V1]: ['edd3c5f5-da8e-463f-8c9a-712aa451d37e'],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2017_EUROPE_10M_YEARLY_V1]: [
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCE_2017,
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCECL,
    ],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2018_EUROPE_10M_YEARLY_V1]: [
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCE_2018,
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCECL,
    ],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2019_EUROPE_10M_YEARLY_V1]: [
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCE_2019,
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCECL,
    ],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2020_EUROPE_10M_YEARLY_V1]: [
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCE_2020,
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCECL,
    ],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2021_EUROPE_10M_YEARLY_V1]: [
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCE_2021,
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCECL,
    ],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2022_EUROPE_10M_YEARLY_V1]: [
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCE_2022,
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCECL,
    ],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2023_EUROPE_10M_YEARLY_V1]: [
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCE_2023,
      COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_IDS.CPMCECL,
    ],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2017_EUROPE_10M_YEARLY_V1]: [
      COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_IDS.CPMCH_2017,
      COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_IDS.CPMCHCL,
    ],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2018_EUROPE_10M_YEARLY_V1]: [
      COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_IDS.CPMCH_2018,
      COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_IDS.CPMCHCL,
    ],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2019_EUROPE_10M_YEARLY_V1]: [
      COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_IDS.CPMCH_2019,
      COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_IDS.CPMCHCL,
    ],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2020_EUROPE_10M_YEARLY_V1]: [
      COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_IDS.CPMCH_2020,
      COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_IDS.CPMCHCL,
    ],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2021_EUROPE_10M_YEARLY_V1]: [
      COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_IDS.CPMCH_2021,
      COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_IDS.CPMCHCL,
    ],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2022_EUROPE_10M_YEARLY_V1]: [
      COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_IDS.CPMCH_2022,
      COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_IDS.CPMCHCL,
    ],
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2023_EUROPE_10M_YEARLY_V1]: [
  ...
  KNOWN_COLLECTIONS_LOCATIONS = {
    ...
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2017_EUROPE_10M_YEARLY_V1]: LocationIdSHv3.cdse,
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2018_EUROPE_10M_YEARLY_V1]: LocationIdSHv3.cdse,
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2019_EUROPE_10M_YEARLY_V1]: LocationIdSHv3.cdse,
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2020_EUROPE_10M_YEARLY_V1]: LocationIdSHv3.cdse,
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2021_EUROPE_10M_YEARLY_V1]: LocationIdSHv3.cdse,
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2022_EUROPE_10M_YEARLY_V1]: LocationIdSHv3.cdse,
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2023_EUROPE_10M_YEARLY_V1]: LocationIdSHv3.cdse,
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2017_EUROPE_10M_YEARLY_V1]: LocationIdSHv3.cdse,
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2018_EUROPE_10M_YEARLY_V1]: LocationIdSHv3.cdse,
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2019_EUROPE_10M_YEARLY_V1]: LocationIdSHv3.cdse,
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2020_EUROPE_10M_YEARLY_V1]: LocationIdSHv3.cdse,
  ...
  MIN_MAX_DATES = {
    ...
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2017_EUROPE_10M_YEARLY_V1]: {
      minDate: moment.utc('2017-01-01'),
      maxDate: moment.utc('2017-12-31'),
    },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2018_EUROPE_10M_YEARLY_V1]: {
      minDate: moment.utc('2018-01-01'),
      maxDate: moment.utc('2018-12-31'),
    },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2019_EUROPE_10M_YEARLY_V1]: {
      minDate: moment.utc('2019-01-01'),
  ...
  TEMPORAL_RESOLUTION = {
    ...
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2017_EUROPE_10M_YEARLY_V1]: { amount: 1, unit: 'year' },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2018_EUROPE_10M_YEARLY_V1]: { amount: 1, unit: 'year' },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2019_EUROPE_10M_YEARLY_V1]: { amount: 1, unit: 'year' },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2020_EUROPE_10M_YEARLY_V1]: { amount: 1, unit: 'year' },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2021_EUROPE_10M_YEARLY_V1]: { amount: 1, unit: 'year' },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2022_EUROPE_10M_YEARLY_V1]: { amount: 1, unit: 'year' },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2023_EUROPE_10M_YEARLY_V1]: { amount: 1, unit: 'year' },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2017_EUROPE_10M_YEARLY_V1]: { amount: 1, unit: 'year' },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2018_EUROPE_10M_YEARLY_V1]: { amount: 1, unit: 'year' },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2019_EUROPE_10M_YEARLY_V1]: { amount: 1, unit: 'year' },
    [COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2020_EUROPE_10M_YEARLY_V1]: { amount: 1, unit: 'year' },
  ...
  getCollectionIdByDatasetIdAndLayerId(datasetId, layerId) {
    switch (datasetId) {
      ...
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2022_EUROPE_10M_YEARLY_V1:
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2023_EUROPE_10M_YEARLY_V1:
        return COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_COLLECTION_ID_BY_LAYER_ID[layerId];
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2017_EUROPE_10M_YEARLY_V1:
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2018_EUROPE_10M_YEARLY_V1:
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2019_EUROPE_10M_YEARLY_V1:
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2020_EUROPE_10M_YEARLY_V1:
      ...
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2022_EUROPE_10M_YEARLY_V1:
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2023_EUROPE_10M_YEARLY_V1:
        return COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_COLLECTION_ID_BY_LAYER_ID[layerId];
      case COPERNICUS_CLMS_DLTC_EUROPE_20M_3YEARLY_V1:
  ...
  getBandsByDatasetIdAndLayerId(datasetId, layerId) {
    switch (datasetId) {
      ...
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2022_EUROPE_10M_YEARLY_V1:
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_EMERGENCE_2023_EUROPE_10M_YEARLY_V1:
        return COPERNICUS_CLMS_CPMCE_10M_YEARLY_V1_BANDS_BY_LAYER_ID[layerId];
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2017_EUROPE_10M_YEARLY_V1:
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2018_EUROPE_10M_YEARLY_V1:
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2019_EUROPE_10M_YEARLY_V1:
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2020_EUROPE_10M_YEARLY_V1:
      ...
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2022_EUROPE_10M_YEARLY_V1:
      case COPERNICUS_CLMS_VLCC_MAIN_CROP_HARVEST_2023_EUROPE_10M_YEARLY_V1:
        return COPERNICUS_CLMS_CPMCH_10M_YEARLY_V1_BANDS_BY_LAYER_ID[layerId];
      default:
