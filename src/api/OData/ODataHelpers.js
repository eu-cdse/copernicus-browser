...
export const getODataCollectionInfoFromDatasetId = (datasetId, { orbitDirection }) => {
...
const createCollectionFilter = ({ collection, geometry }) => {
  ...
  //add collection id
  collectionFilter.startsWith(AttributeNames.productName, collection.id);
...
*/
const createBasicSearchQuery = ({ fromTime, toTime, orbitDirection, geometry, datasetId }) => {
  const oDataCollectionInfo = getODataCollectionInfoFromDatasetId(datasetId, { orbitDirection });
  let collections = [];
