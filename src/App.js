...
class App extends Component {
  ...
  setShowLayerPanel = (showLayerPanel) => {
    if (showLayerPanel) {
      this.setState({ showLayerPanel, showComparePanel: false, showPinPanel: false });
    } else {
  ...
  setShowPinPanel = (showPinPanel) => {
    if (showPinPanel) {
      this.setState({ showPinPanel, showComparePanel: false, showLayerPanel: false });
    } else {
  ...
  setShowComparePanel = (showComparePanel) => {
    if (showComparePanel) {
      if (this.props.is3D) {
        ...
        this.setState({ showComparePanel, showPinPanel: false, showLayerPanel: false });
      }
    } else {
